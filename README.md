...
Using exhaustive search follows a time complexity of  O(n \cdot 2^n) , while dynamic programming (DP) follows a time complexity of  O(n^2) , as confirmed through a scatter plot.
