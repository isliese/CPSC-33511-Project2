...
* To draw scatter plots for two algorithms and compare with theoretical time complexity: `python scatterplot.py` <br> <br>
  ...
  You can see [Dynamic Programming Execution Time vs Grid Size] graph first. Once you close the window with X button, and see [Exhaustive Search Execution Time vs Grid Size] graph next.
